...
CSV_FILE="/data/gd_mkt_rna_ops/cvm_ops/data_collection/en_cvm_campaign_wl_border_${RUN_DATE}.csv"
...
PG_TABLE="${PG_SCHEMA}.source_cvm_wl_border"
TEMP_TABLE="${PG_SCHEMA}.temp_cvm_wl_border"
