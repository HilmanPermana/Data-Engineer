...
AND b.event_date='2026-05-01'
WHERE a.strmonth='2026-05-01'
...
export_file="${export_dir}/cvm_taker_kabupaten_${data_date}.csv"

echo "Start export..."

# header manual
echo "extract_date,data_date,strmonth,offer_id,kabupaten,total_msisdn,trx,revenue" > "${export_file}"
