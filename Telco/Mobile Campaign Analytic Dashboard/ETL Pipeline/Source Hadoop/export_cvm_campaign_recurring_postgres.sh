...
CSV_FILE="/data/gd_mkt_rna_ops/cvm_ops/data_collection/en_cvm_campaign_wl_recurring_${RUN_DATE}.csv"
...
PG_TABLE="${PG_SCHEMA}.source_en_cvm_campaign_wl_recurring"
TEMP_TABLE="${PG_SCHEMA}.temp_en_cvm_campaign_wl_recurring"
