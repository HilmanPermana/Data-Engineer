-- DROP FUNCTION cvm_data.fn_top_main_level(date);

CREATE OR REPLACE FUNCTION cvm_data.fn_top_main_level(p_strmonth date)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
BEGIN

DELETE FROM cvm_data.top_main_level
...
-- FINAL
-- =========================
INSERT INTO cvm_data.top_main_level
SELECT 
    a.strmonth,
    a.tower,
    a.wltype,
